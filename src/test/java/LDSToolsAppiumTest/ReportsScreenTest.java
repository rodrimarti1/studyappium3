...
//        System.out.println(myBasePage.getSourceOfPage());
        ...
        Assert.assertTrue(myBasePage.checkNoCaseList("Proxy", pageSource, "Contains"));
...
//        System.out.println(pageSource);
    ...
    private void getMembersMovedInReport(int rights) throws Exception {
        ...
        pageSource = myBasePage.getSourceOfPage();
//        System.out.println(pageSource);
        Assert.assertTrue(myBasePage.checkNoCaseList("Maswanya", pageSource, "Contains"));
...
//        Assert.assertFalse(myBasePage.checkNoCaseList("Windu, Mace", pageSource, "Contains"));
        ...
        if (getRunningOS().equalsIgnoreCase("ios")) {
            ...
            pageSource = myBasePage.getSourceOfPage();
            Assert.assertTrue(myBasePage.checkNoCaseList("Butandu", pageSource, "Contains"));
